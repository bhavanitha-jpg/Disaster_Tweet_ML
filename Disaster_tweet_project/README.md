...
| Model               | Feature Extraction          |  Accuracy  | Precision | Recall | F1 Score | Advantages                                                                  | Limitations                                                                                                      |
| ------------------- | --------------------------- | :--------: | :-------: | :----: | :------: | --------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| Logistic Regression | TF-IDF (Unigrams + Bigrams) | **0.8043** |    0.82   |  0.69  |   0.75   | Fast training, interpretable, strong baseline performance                   | Limited understanding of contextual meaning                                                                      |
| Linear SVM          | TF-IDF (Unigrams + Bigrams) | **0.7781** |    0.75   |  0.72  |   0.73   | Effective for high-dimensional sparse text data                             | Slightly lower performance than Logistic Regression                                                              |
| DistilBERT          | Transformer Embeddings      |   0.4872   |    0.39   |  0.34  |   0.36   | Captures contextual language representations and supports transfer learning | Underperformed in this project due to limited training setup and hyperparameter tuning on the available hardware |

### Final Model Selection

Although DistilBERT is a powerful transformer-based model, the TF-IDF + Logistic Regression pipeline achieved the best validation performance for this dataset.

**Final selected model:** **TF-IDF + Logistic Regression**

**Reason for selection:**

* Highest validation accuracy (80.43%)
* Better precision and F1-score than the other evaluated models
* Faster training and inference
* Lower computational requirements
* More suitable for the project constraints and available hardware
